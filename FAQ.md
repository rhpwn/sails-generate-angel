...
```sh
$ npm install sails-generate-angel
```

[![NPM](https://nodei.co/npm/sails-generate-angel.png?downloads=true&stars=true)](https://nodei.co/npm/sails-generate-angel/)
...
[![githalytics.com alpha](https://cruel-carlota.pagodabox.com/8acf2fc2ca0aca8a3018e355ad776ed7 "githalytics.com")](http://githalytics.com/balderdashy/sails-generate-angel/FAQ.md)
