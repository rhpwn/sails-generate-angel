...
```sh
$ npm install -g sails-generate-angel
```
...
$ angel new myApp
```
this command generates a new sails application with www folder included, here is the frontend. You can also run this command with --no-frontend option 
...
**[MIT](./LICENSE)**
&copy; 2015 [rhpwn](http://github.com/rhpwn) & contributors
